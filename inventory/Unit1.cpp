...
void TForm1::addtotablesotr()
{
	...
	Form5->StringGrid1->Cells[0][0]="№ п/п";
	Form5->StringGrid1->Cells[1][0]="Ф.И.О.";
	Form5->StringGrid1->Cells[2][0]="Отделение";
	Form5->StringGrid1->Cells[3][0]="Должность";
	Form5->StringGrid1->Cells[4][0]="Состояние";
	Form5->StringGrid1->Cells[5][0]="Контактные данные";
	...
	Form5->StringGrid1->Cells[4][i]="Работает";
	}
	else
	{
	Form5->StringGrid1->Cells[4][i]="Не работает";
	}
...
void TForm1::addtotable()
{
	...
	StringGrid1->Cells[2][0]="Инв. Номер";
	StringGrid1->Cells[3][0]="Характеристики";
	StringGrid1->Cells[4][0]="Кабинет";
	StringGrid1->Cells[5][0]="Отдел";
	StringGrid1->Cells[6][0]="Ответственный";
	StringGrid1->Cells[7][0]="Комплект";
