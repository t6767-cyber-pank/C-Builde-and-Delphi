...
// Вторичный запросы касательно данных из combobox
 ...
 case 1: table="tovar";
		 ...
		 switch(y)
		 {
		   case 1:
				   ...
				   a[1]="№ п/п";
				   a[2]="Товар";
				   a[3]="Единицы измерения";
				   a[4]="Цена";
				   a[5]="Поставщик";
				   a[6]="Примечание";
				   a[7]="Контактные данные";
				   a[8]="Категории";
				   b[1]=data[1];
				   b[2]=data[2];
				   b[3]=data[3];
...
// вывод данных в компонент таблицы
...
// Вывод данных в комбинированное поле ввода
