 ...
 case 6: switch(y)
		 {
		   ...
		   case 4:  ADOQuery1->SQL->Text="select * from skladost order by naim asc";
					ADOQuery1->Active=true;
					adtolb(StringGrid3, "naim", "id_sklad", "склад");
					break;
		   case 5:  ADOQuery1->SQL->Text="select * from kuhnya order by knaim asc";
					ADOQuery1->Active=true;
					adtolbplus(StringGrid3, "knaim", "id_kuhnya", "кухня");
					break;
		   case 6:
		   ...
		   case 7:
					...
					if (ComboBox7->Text=="Сделайте выбор") {ComboBox7->Text="%%";}
 ...
 case 8: switch(y)
		 {
		   case 1:
				   clearmas();
				   ADOQuery1->SQL->Text="select * from recept r, blud b, skladost s where b.id_blud=r.id_blud and r.id_blud=:id_blud and r.idskladprih=s.id_sklad and r.nazn='склад' order by naim asc";
				   ADOQuery1->Parameters->ParamByName("id_blud")->Value=StringGrid1->Cells[4][StringGrid1->Row];
				   ADOQuery1->Active=true;
				   a[1]="Ингридиенты";
				   a[2]="Пропорции";
				   ...
				   ADOQuery1->SQL->Text="select * from recept r, blud b, kuhnya s where b.id_blud=r.id_blud and r.id_blud=:id_blud and r.idskladprih=s.id_kuhnya and r.nazn='кухня' order by knaim asc";
				   ADOQuery1->Parameters->ParamByName("id_blud")->Value=StringGrid1->Cells[4][StringGrid1->Row];
				   ADOQuery1->Active=true;
				   a[1]="Ингридиенты";
				   a[2]="Пропорции";
...
case 12: switch(y)
		 {
		   case 1:
				   ...
				   StringGrid2->ColWidths[0]=200;
				   StringGrid2->ColWidths[1]=100;
				   StringGrid2->Cells[0][0]="Ингридиенты";
				   StringGrid2->Cells[1][0]="Пропорции";
				   StringGrid2->Cells[2][0]="0";
				   for (int i = 1; i < 100; i++) {
				   StringGrid2->Cells[0][i]="";
				   ...
				   Panel1->Visible=true;
				   Label1->Caption="Наименование";
				   Label2->Caption="Количество";
				   Label7->Caption="Дата создания";
...
case 15:
		...
		case 8:
					...
					ADOQuery1->SQL->Text="select *, s.kolvo as sk from recept r, skladost s where s.id_sklad=r.idskladprih and r.id_blud=:id_blud and r.nazn='склад'";
					...
					ADOQuery1->SQL->Text="select *, s.kolvo as sk from recept r, kuhnya s where s.id_kuhnya=r.idskladprih and r.id_blud=:id_blud and r.nazn='кухня'";
					ADOQuery1->Parameters->ParamByName("id_blud")->Value=StringGrid1->Cells[6][i];
					ADOQuery1->Active=true;
					while (!ADOQuery1->Eof)
					{
...
case 17: switch(y)
		 {
		   case 1:
				   ...
				   Label2->Caption="Количество";
				   Label7->Caption="Дата создания";
				   Label5->Caption="Цена за единицу";
 ...
 case 19:
		...
		case 1:
				   ...
				   a[2]="Блюдо";
				   a[3]="Цена";
				   a[4]="Остаток на начало";
				   a[5]="Сумма начало";
				   a[6]="Остаток на Конец";
				   a[7]="Сумма конец";
				   a[8]="Количество";
				   a[9]="Сумма";
				   b[1]="knaim";
...
String xx=xc;
String xy=ac;
Label18->Caption="Сумма: "+xx+" "+"Количество: "+xy;
}
if (tab==10) {
zap(10, 8);
double xc;
